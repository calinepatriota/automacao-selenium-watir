  ...
  def teste_addUsserMatJaExiste
   ...
   @browser.text_field(:id, "user_enrollment").clear
	...
	@browser.element(:css => "#formAuth > button:nth-child(9)").click
		...
		@browser.text_field(:css => "#user_enrollment").set("123456789")
		@browser.text_field(:css => "#user_email").set("teste907@teste.com")
		...
		assert @browser.element(:xpath=> ".//*[@id='alert-error']/ul/li").text.include? 'Matrícula já está em uso'
